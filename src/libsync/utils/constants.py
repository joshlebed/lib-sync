...
SPOTIFY_API_MAX_CONCURRENT_PLAYLIST_WRITES = int(
    os.environ.get("SPOTIFY_MAX_CONCURRENT_PLAYLIST_WRITES", "5")
)  # Max playlists overwritten in parallel - limits the API burst to reduce 429s
